...
ALTER TABLE [dbo].[HRA.SALARYSCHEME]  WITH CHECK ADD  CONSTRAINT [FK_SALARYSCHEME_COMPONENT] FOREIGN KEY([COMPONENTID])
REFERENCES [dbo].[HRA.SALARYCOMPONENT] ([ID])
GO

ALTER TABLE [dbo].[HRA.SALARYSCHEME] CHECK CONSTRAINT [FK_SALARYSCHEME_COMPONENT]
GO
