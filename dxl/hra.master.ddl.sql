...
*INSERT DATA
*/
INSERT INTO "hra-3".dbo."HRA.MEDICALBILL"(EMPLOYEEID,BILLDESCRIPTION, BILLPATH, CRTBY,CRTON) VALUES (('2'), ('first bill'),('C:/sdb/ctxdeploy/hras.war/100/57866_2.1.PNG'), ('admin'), GETDATE());
...
CREATE TABLE [dbo].[HRA.MEDICALBILL](
	ID int NOT NULL IDENTITY (1,1),
	...
	CRTON date NOT NULL,
	CONSTRAINT PK_MEDICALBILL PRIMARY KEY (ID)
 );
