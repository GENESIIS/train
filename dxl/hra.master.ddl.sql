...
MANAGERID INT NOT NULL CONSTRAINT DF_MANAGERID_DEPARTMENT DEFAULT ('-') ,
...
CREATE TABLE [HRA.LOAN] (
  ...
  TOTALOUTSTANDING double NOT NULL CONSTRAINT DF_TOTALOUTSTANDING_LOAN DEFAULT 0.00 ,
  BORROWER varchar(200) NOT NULL CONSTRAINT DF_BORROWER_LOAN DEFAULT ('-') ,
  MONTHLYPAYMENT double NOT NULL CONSTRAINT DF_MONTHLYPAYMENT_LOAN DEFAULT 0.00 ,
