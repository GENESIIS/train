		...
		<div class="modal-content">
			...
			<div class="modal-body" onload="ready()">
				...
				<div class="btn-group btn-group-justified">
					...
					<a id="btnEmpHisDet" href="#" onclick="loadAddEmployementHIstoryDetails()"
					class="btn btn-primary">Employee History Details</a>
					<a id="btnMedicalHistory"  href="#" onclick="loadAddMedicalHIstoryDetails()"
			...
			<div class="modal-body">
				...
				<div class="btn-group btn-group-justified">
					<a href="#" onclick="loadEditContentqualifications()"
						...
						class="btn btn-primary">Family Details</a>
						<a id="btnEmployeeHistory" href="#" onclick="loadEditEmployementHIstoryDetails()"	
						class="btn btn-primary">Employee History Details</a>
						<a id="btnMedicalHistory"  href="#" onclick="loadEditMedicalHIstoryDetails()" 
						class="btn btn-primary">Medical History</a>
				</div>
