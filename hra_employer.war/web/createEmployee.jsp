		...
		<div class="modal-content">
			...
			<div class="modal-body">
				...
				<div class="btn-group btn-group-justified">
					<a href="#" onclick="loadContentqualifications()" class="btn btn-primary">Educaional Daa</a> <a onclick="loadContentstudyprograms()" href="#"
						class="btn btn-primary">Study Programs</a> <a href="#" onclick="loadContentloandetails()"
