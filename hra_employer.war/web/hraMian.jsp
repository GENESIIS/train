...
<title>Human Resources Management System | Dashboard</title>
...
<!-- Date Picker -->
<link rel="stylesheet"
	href="AdminLTE/plugins/datepicker/datepicker3.css">
<!-- Daterange picker -->
<link rel="stylesheet"
	href="AdminLTE/plugins/daterangepicker/daterangepicker-bs3.css">
	...
	<div class="wrapper">
				...
				<div class="navbar-custom-menu">
					<ul class="nav navbar-nav">
						...
						<li class="dropdown user user-menu"><a href="#"
							...
							<ul class="dropdown-menu">
								<!-- User image -->
								<li class="user-header"><img src="" class=""
									alt="User Image">
									<p>
				...
				<ul class="sidebar-menu">
					...
					<li class="active treeview"><a href="#"> <i
						...
						<ul class="treeview-menu">
							<li><a onclick="helloWorld()"><i class="fa fa-user"></i>
									Employee Management</a></li>
							<li><a href=""><i class="fa fa-building-o"></i>
		...
		<div class="content-wrapper">
			...
			<section class="content-header">
				<h1>
					Human Resources Management <small>Control panel</small>
				</h1>
			</section>
		</div>
	</div>
