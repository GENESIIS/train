...
<div>
				<div>
							...
							<div class="modal-body">
								...
								<div>
									<label><h3 class="modal-title">		<i class="glyphicon glyphicon-check"></i>Employment History	</h3></label>
								</div>
							
								<div class="form-group">
									<label for="employeeId">Employee</label> <input type="text"	class="form-control" id="employeeId" name="employeeId"	placeholder="">
								</div>
								<div class="form-group">
									<label for="employer">Employer</label> <input type="text" class="form-control" id="employer" name="employer" placeholder="">
								</div>
								<div class="form-group">
									<label for="designation">Designation</label> <input type="text" class="form-control" id="designation" name="designation" placeholder="">
								</div>
								<div class="form-group">
									<label for="basis">Basis (Contract/Intern/Permanent)</label> <input type="text" class="form-control" id="basis" name="basis" placeholder="">
								</div>
								<div class="row">
									<div class="col-md-6">
										<div class="form-group">
								...
								<div >
									<button type="button" class="btn btn-success pull-side" onclick="addEmployeeHistoryDetails();">
				...
				<table id="employmentHistorydetails" class="table table-striped table-bordered table-responsive" cellspacing="0" width="100%">
					<thead>
						<tr>
							<th>Employee</th>
							<th>Employer</th>
