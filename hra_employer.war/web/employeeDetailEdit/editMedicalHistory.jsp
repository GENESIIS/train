		...
		<div class="modal-body">
			...
			<div>
				<h3 class="modal-title">
					<label> <i class="glyphicon glyphicon-check"></i> Edit
						Medical History
					</label>
				</h3>
			</div>
			...
			<div class="well">
					...
					<div class="col-md-6">
						<div class="form-group">
							<label for="employeeId">Employee EPF</label> <input type="text"
								...
								placeholder="" maxlength="10" readonly>
				...
				<div class="row">
					...
					<div class="col-md-6">
						<div class="form-group">
							<div class="form-group">
								<label for="employeeAilment">Ailment Type</label> <select
									class="form-control" id="employeeAilmentedit"
									name="employeeAilmentedit">
									<option value="">--Select--</option>
									<c:forEach var="entry" items="<%=AilmentEnum.values()%>">
											<option ${AilmentEnum.values() == employeeAilmentedit ? 'selected' : ''}>${entry.key}</option>
									</c:forEach>
								</select>
							</div>
						</div>
					...
					<div class="col-md-6">
						<div class="form-group">
							<label for="ailmentDescription">Ailment Description</label> <input
								type="text" class="form-control" id="ailmentDescriptionedit"
								name="ailmentDescriptionedit" placeholder="" maxlength="100">
						</div>
					</div>
			...
			<div class="well">
				...
				<div class="row">
					<div class="col-md-6">
						<div class="form-group">
							<label for="reportDescription">Report Description</label> <input
								type="text" class="form-control" id="reportDescriptionEdit"
								name="reportDescriptionEdit" placeholder="Report Description"
								maxlength="100">
						</div>
					</div>
					<div class="col-md-6">
						<div class="form-group">
							...
							<div class="fileinput fileinput-new" data-provides="fileinput">
								...
								<div class="fileinput-new thumbnail"
									...
									<img class="changesrc" data-src="holder.js/100%x100%"
