...
// var c = (b.scrollable === true) ? 'style="max-height: 420px;overflow-y:
// auto;"'
// : "";
...
// src="'+pdf_link+'"></iframe></div>'
// //var iframe = '<object data="'+pdf_link+'" type="application/pdf"><embed
// src="'+pdf_link+'" type="application/pdf" /></object>'
// var iframe = '<object type="application/pdf" data="'+pdf_link+'" width="100%"
// height="500">No Support</object>'
// $.createModal({
// title:'Report',
// message: iframe,
// closeButton:true,
