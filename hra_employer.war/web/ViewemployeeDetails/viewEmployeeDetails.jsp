		...
		<div class="tab-pane active" id="tabPageEmployee">
			<div id="Employee" class="reviewBlock" data-content="List"
				...
				<ul class="nav nav-tabs" id="subModTab"
					...
					<li class="active"><a id="tabBasic" href="">Basic
							Information</a></li>
					<li class=""><a id="tabQualifications" href="">Qualifications</a></li>
				...
				<div class="tab-pane active" id="tabPageBasic"
...
<!-- 				<div class="tab-pane" id="tabPageQualifications" -->
<!-- 					style="border: 1px solid #DDD;"> -->
