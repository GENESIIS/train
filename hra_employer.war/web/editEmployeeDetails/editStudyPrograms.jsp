	...
	<div class="">
		<div class="well">
			...
			<div class="row">
				...
				<div class="col-md-6">
					<div class="form-group">
						<label for="admissionDate">End Date</label> <input type="date"
							class="form-control" id="editProgramEndDate"
				...
				<div class="col-md-6">
					<div class="form-group">
						<label for="duration">Duration (In months)</label> <input
							type="number" class="form-control" id="editDuration"
							name="editDuration" placeholder="">
					</div>
				</div>
				<div class="col-md-6">
					<div class="form-group">
						<label for="studyTime">Study Time</label><br> <label
							for="stWeekdays"><input type="checkbox"
							class="form-control" id="editStWeekdays" name="editStWeekdays"
							placeholder="">Weekdays </label> <label for=stWeekends> <input
							type="checkbox" class="form-control" id="editStWeekends"
							name="editStWeekends" placeholder="">Weekends
						</label>
					</div>
				</div>
			</div>
