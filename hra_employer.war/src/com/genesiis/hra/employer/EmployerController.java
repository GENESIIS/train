...
public class EmployerController extends HttpServlet {
		...
		static Logger log = Logger
				.getLogger(EmployerController.class.getName());
		...
		public void init() throws ServletException {
			...
			commands.put(Operation.UPDATE_EDU_DETAILS,
					new AddEducationDetails());
			...
			try {
				...
				case ADD_MEDICAL_REPORT:
					...
					if (path != null) {
						...
						message = commands.get(o).execute(details);// do not
																	// delete
																	// need to
																	// improve
