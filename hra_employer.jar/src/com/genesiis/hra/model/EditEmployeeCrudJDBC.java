 ...
 */
@Stateless
public class EditEmployeeCrudJDBC implements IDataAccessor { 

	static Logger log = Logger.getLogger(EditEmployeeCrudJDBC.class.getName());
			 ...
			 retriveData = preparedStatement.executeQuery();			 
				...
				try{
					if (retriveData.next()) {
						...
						employee.setEmployeedateofbirth(retriveData.getString("DOB"));
						employee.setEmployeenic(retriveData.getString("NIC"));
						employee.setEmployeegender(retriveData.getString("GENDER"));
						employee.setEmployeepermenetaddress(retriveData.getString("PERMENENTADDRESS"));
						employee.setEmployeemobile(retriveData.getString("MOBILENO"));
						employee.setEmployeedepartment(retriveData.getString("DEPTID"));
						employee.setEmployeetelephone(retriveData.getString("OTHERNO"));
						employee.setEmployeejoindate(retriveData.getString("DATEOFJOIN"));						
						employee.setEmployeeepf(retriveData.getString("EPF"));
						employee.setEmployeemaritalstatus(retriveData.getString("MARITALSTATUS"));
						employee.setEmployeebasis(retriveData.getString("BASIS"));						
						employee.setEmployeetemporaryaddress(retriveData.getString("TEMPORARYADDRESS"));						
