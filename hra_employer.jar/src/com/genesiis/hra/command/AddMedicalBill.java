...
import com.genesiis.hra.model.MedicalBill;
import com.genesiis.hra.model.MedicalReport;
import com.genesiis.hra.validation.DataValidator;
import com.genesiis.hra.validation.MessageList;
import com.google.gson.Gson;

public class AddMedicalBill implements ICommandAJX {
	static Logger log = Logger.getLogger(AddMedicalBill.class.getName());
	...
	public String execute(String gsonData) {
		...
		try {
			...
			MedicalBill medicalBill = (MedicalBill) extractFromJason(gsonData);
