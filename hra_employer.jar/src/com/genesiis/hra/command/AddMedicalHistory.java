...
public class AddMedicalHistory implements ICommandAJX {
	...
	//@TR - update employee medical history report
	public String execute(String gsonData, String code) {
				...
				try {
					...
					if (!hasError) {
						...
						int hasUpdated = medicalHistory.update(medicalHistory,code);
